        ...
        <div className="row pt-5">
            ...
            <div className="col-lg-3 col-md-6 mb-5">
                ...
                <div className="d-flex flex-column justify-content-start">
                    <a className="text-white mb-2" href="#"><i class="fa fa-angle-right mr-2"></i>Home</a>
                    <a className="text-white mb-2" href="#"><i class="fa fa-angle-right mr-2"></i>About Us</a>
                    <a className="text-white mb-2" href="#"><i class="fa fa-angle-right mr-2"></i>Our Features</a>
                    <a className="text-white mb-2" href="#"><i class="fa fa-angle-right mr-2"></i>Classes</a>
                    <a className="text-white" href="#"><i class="fa fa-angle-right mr-2"></i>Contact Us</a>
                </div>
            </div>
            <div className="col-lg-3 col-md-6 mb-5">
